...
//           >
//             {/* Timeline Dot */}
//             <div className="absolute left-8 md:left-1/2 transform -translate-x-1/2 w-4 h-4 bg-[var(--retro-primary)] border-4 border-[var(--foreground)] rounded-full z-10 shadow-[2px_2px_0px_var(--foreground)]"></div>
